...
export default function VideoCard({ video, isAdmin, viewers, sharingId, onShareClick, onShareSelect, canDelete, onDeleteClick, index }) {
  ...
  return (
    <article className="group glass rounded-2xl border border-zinc-200 dark:border-zinc-700 shadow-soft overflow-hidden hover:shadow-soft-lg transition-shadow duration-200">
      <motion.div
